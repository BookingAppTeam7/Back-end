...
VALUES (1, '2023-02-10 10:57:00', '2023-02-15 10:57:00', false);


-- Insert PriceCard data
INSERT INTO price_card(time_slot_id, price, type, deleted) VALUES
    (1, 2000, 'PERGUEST', false);
-- Add more rows as needed
...
INSERT INTO accommodations (id,name, description, location_id, min_guests, max_guests, type, owner_id, status, cancellation_deadline, reservation_confirmation, deleted) VALUES
    (null,'ime', 'opis', 1, 2, 5, 'APARTMENT', 'owner', 'PENDING', 5, 'MANUAL', false);
