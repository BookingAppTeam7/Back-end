...
public class ReviewPutDTO {//
    ...
    public ReviewPutDTO(String userId, ReviewEnum type, String comment, int grade, LocalDateTime dateTime, Boolean deleted, Boolean reported, Long accommodationId, String ownerId,
