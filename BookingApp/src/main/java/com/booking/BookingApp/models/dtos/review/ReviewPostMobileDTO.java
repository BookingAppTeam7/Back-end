...
public class ReviewPostMobileDTO {
    ...
    public ReviewPostMobileDTO(String userId, ReviewEnum type, String comment, int grade, Boolean deleted, Boolean reported, Long accommodationId, String ownerId,
